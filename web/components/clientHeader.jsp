...
<%
    ...
    if (cusCartList == null) {
        ...
        countProdCart = cusCartList.size();
    }
...
<nav class="navbar navbar-expand fixed-top navbar-dark bg-white mb-0" style="position:fixed;">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav mx-auto">
            <li class="nav-item"><a class="" href="#"><img src="images/hoot9elogo-01.png" alt="logo" width="90%"></img></a></li>
        </ul>
        <%if (userID == null) {%>
        <ul class="navbar-nav" >
        ...
        <ul class="cart-all navbar-nav" style="margin-right:20px;" onmouseover="cartStartHover(this)" onmouseout="cartEndHover(this)">
            <li class="nav-item">
                <form action="CartControl" method="POST" id="displayCartForm">
                    <input type="hidden" value="displayCart" name="cartAction">
                        <a href="CartControl?cartAction=displayCart" class="cart-icon nav-link pr-0">
            ...
            <li class="nav-item">
                <a href="CartControl?cartAction=displayCart"  class="nav-link pl-0 pr-0"  href="#"><span id="cart-num" style="color:#bfbfbf;">(<%=countProdCart%>)</span></a>
            </li>
        </ul>
        <%}%>
    </div> 
