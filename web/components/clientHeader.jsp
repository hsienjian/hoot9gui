    ...
    <div class="container">
        ...
        <ul class="navbar-nav">
            <li class="nav-item pr-1">
                <a class="user-icon nav-link pointer" id="user-dropdown" onmouseover="hoverStartDropdown(this)" onmouseout="hoverEndDropdown2(this)">
        ...
        <ul class="cart-all navbar-nav" onmouseover="cartStartHover(this)" onmouseout="cartEndHover(this)">
            <li class="nav-item">
                <a class="cart-icon nav-link pr-0" href="#">
