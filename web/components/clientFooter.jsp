                ...
                <div class="row ml-3 font-white">
                    ...
                    <div class="about-us col-xl-4 col-md-4">
                        ...
                        <p class="font-reduce-size font-white">
                            ...
                            purchase our products anytime with their
                            devices.<br>
                            "Lets hoot9 the purcahse button!!"
                        </p>
                    </div>
                </div>
            </div>
