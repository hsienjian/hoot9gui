        ...
        <div id="div">
            ...
            <div class="container mt-4">
                <div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between padding-top-2x padding-bottom-1x">
                    <div class="step ${orderDetails.getStatus()=="Packaging" || orderDetails.getStatus()=="Delivery" || orderDetails.getStatus()=="Completed" ? "completed":""}">
