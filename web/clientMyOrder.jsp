            ...
            <div class="row mb-3">
                <div class="col-md-8 col-sm-12 col-12">
                    <div class="row btn-center">
                        ...
                        <div class="p-2">
                            <a href="OrderRecordControl?ordOpt=2" class="btn btn-dark">Packaging</a>
                        </div>
                        <div class="p-2">
                            <a href="OrderRecordControl?ordOpt=3" class="btn btn-dark">Shipping</a>
                        </div>
                        <div class="p-2">
                            <a href="OrderRecordControl?ordOpt=4" class="btn btn-dark">Delivered</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mb-4 shadow bg-white rounded">
                <div class="row">
                    ...
                    <div class="col-md-3 bg-dark rounded">
                        <%if (orderList.get(i).getStatus().equals("Packaging")) {%>
                        ...
                        <%} else if (orderList.get(i).getStatus().equals("Shipping")) {%>
                        <div class="text-center p-3 pt-2 mt-4">
                        ...
                        <%} else if (orderList.get(i).getStatus().equals("Delivered")) {%>
                        <div class="text-center p-3 pt-2 mt-4">
